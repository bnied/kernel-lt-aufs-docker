...
cd /opt/kernel-lt-aufs/specs-el7/
...
cp specs-el7/kernel-lt-aufs-$KERNEL_BASE_VERSION.spec /root/rpmbuild/SPECS/
...
rpmbuild --rebuild kernel-lt-aufs-$KERNEL_FULL_VERSION-$RELEASE_VERSION.el7.src.rpm
